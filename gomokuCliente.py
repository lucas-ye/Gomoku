...
class myThread (threading.Thread):
    def __init__(self, IP_destino, PORTA_destino):
        threading.Thread.__init__(self)
        self.minhaVez = True
        self.IP_destino = IP_destino
        self.PORTA_destino = PORTA_destino
        # Criação de socket UDP do cliente
        self.sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
        self.sock.bind((self.IP_destino, 9997))
    ...
    def send(self, lista):
        ...
        self.sock.sendto(json.dumps(lista).encode("utf-8"), (self.IP_destino, self.PORTA_destino))
        self.minhaVez = False
...
def focus(xi, yi):
    ...
    pygame.draw.circle(surface, (0, 0, 0, 100), (x, y), 16)
...
def desenharTabuleiro():
    ...
    fraseTexto = fonteTexto.render("Jogador: Cliente", True, (226, 29, 44))
...
pygame.display.set_caption("Gomoku Cliente")
